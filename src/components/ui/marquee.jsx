...
export function Demo() {
  return (
    <div className=" mt-10 border-y border-neutral-500 py-3 flex items-center justify-center">
      <Marquee>
        ...
        <MarqueeContent speed={80}>
          {animationsList.map((animation, i) => (
            <MarqueeItem key={i} className="mx-3">
              <div>
                <p className=" text-base md:text-xl text-neutral-400 font-heading font-extrabold" >{animation} <span className='text-lime text-2xl' >&nbsp; ✦</span> </p>
              </div>
            </MarqueeItem>
          ))}
        </MarqueeContent>
